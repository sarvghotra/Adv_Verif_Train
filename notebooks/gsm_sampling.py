...
def greedy_sampling_acc(rank, args):
    ...
    for tempera in [0.7]:
        ...
        for step, batch in tqdm(enumerate(dataloader), total=len(dataloader)):
            ...
            for idx in range(len(inputs_string)):
                ...
                final_ans = extract_answer_from_response(response, delimiter='The answer is: ')
...
if __name__ == "__main__":
    ...
    parser.add_argument("--base_model", 
                        default="/lustre/fsw/portfolios/llmservice/users/sghotra/models/pre_train/Meta-Llama-3.1-8B-Instruct", type=str, help="model path")
    parser.add_argument("--data_path", 
                        default="/lustre/fsw/portfolios/llmservice/users/sghotra/data/grade-school-math/grade_school_math/data/train.jsonl", type=str, help="config path")
    parser.add_argument("--batch_size", type=int, default=64, help="batch size")
    
    parser.add_argument("--return_seq_num", type=int, default=16, help="number of sequences per sample to return")
    ...
    parser.add_argument("--task", default="gsm_llama_inst", type=str, help="Name of the task for eval")
    args = parser.parse_args()

    local_rank = 0
    greedy_sampling_acc(local_rank, args)
