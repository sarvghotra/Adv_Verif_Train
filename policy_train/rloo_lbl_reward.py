...
from policy_train.rloo_trainer_lbl_reward import RLOOLabelRewardTrainer
...
def main():
    ...
    eval_dataset, _ = create_datasets(script_args, policy_tokenizer, script_args.eval_dataset_name)
    ...
    trainer = RLOOLabelRewardTrainer(
